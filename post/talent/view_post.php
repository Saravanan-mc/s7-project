...
<head>
    ...
    <style>
        ...
        .post-detail-media iframe {
            width: 100%;
            max-width: 640px; /* Larger embed size */
            height: 360px;
            border: none;
            border-radius: 6px;
        }
...
<body>
    ...
    if ($post) {
        ...
        echo "<h2>Roll No: " . htmlspecialchars($post['roll_number']) . " - " . htmlspecialchars($post['name']) . "</h2>";
        ...
        echo "<p class='post-not-found-message'>Post not found. Please check the URL or view all posts.</p>";
    }
    ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (postId) { // Only run if a post ID is actually present
